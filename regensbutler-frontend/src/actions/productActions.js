...
export const listProducts = (
  ...
  try {
    ...
    const { data } = await axios.get(
      `/api/products/admin?keyword=${keyword}&pageNumber=${pageNumber}&key_kat=${key_kat}&key_ukat=${key_ukat}&key_dkat=${key_dkat}`, config
    );
    dispatch({
...
export const listCategories = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/products/kategorien`);
    dispatch({
